            ...
            try{
                ...
                if(username != null && password != null){
                    ...
                    if(userRegistered != null){
                        ...
                        if(formName != null && questionNumber > 0){
                            String formId = _context.RegisterForm(username, password, formName, questionNumber);
                            if (formId == "" || formId == null) out.println(format.GetLastError());
                            else out.println(format.GetResponseInJson("ok", "1", formId));
                        }else{
