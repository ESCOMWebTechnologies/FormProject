 ...
 * @author miku
 */
@WebServlet(name = "FormCreate", urlPatterns = {"/CreateForm"})
                ...
                try {
                    ...
                    if(responses != null){
                        ...
                        if(user != null){
                            ...
                            }while(_context.ExistId(id, "forms"));
                            if(_context.CreateForm(user.GetId(),formName,questionNumber,id)){
                                out.println(String.format(formatJson,"response","ok"));
                                out.println(String.format(formatJson,"statusCode","1"));
                                out.println(String.format(formatJson,"message", id));
                                out.flush();
                            }else{
