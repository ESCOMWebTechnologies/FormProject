 ...
 * @author miku
 */
@WebServlet(name = "DeleteQuestion", urlPatterns = {"/Forms/api/DeleteQuestion"})
            ...
            try{
                ...
                if(username != null && password != null){
                    ...
                    if(userRegistered != null){
                        ...
                        if(questionId != null){
                            Boolean removed = _context.RemoveQuestion(questionId, userRegistered.GetId());
                            if(removed) out.println(format.GetResponseInJson("ok", "1", "Removed"));
